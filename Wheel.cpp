...
void Wheel::Update()
{
	...
	if (collidedLeftX == true){ for (int j = 0; j < 4; j++) { cameraPosition.x -= 0.1; } }
	if (collidedRightX == true){ for (int k = 0; k < 4; k++) cameraPosition.x += 0.1; }
	if (collidedLeftZ == true){ for (int l = 0; l < 4; l++) cameraPosition.z -= 0.1; }
	if (collidedRightZ == true){ for (int m = 0; m < 4; m++) cameraPosition.z += 0.1; }
}
